...
class IllegalUserIdentityException(message: String? = "Invalid User info", cause: Throwable? = null) : StatusCodeException.BadRequest(message, cause)
class InvalidTokenException(message: String? = "Invalid Token", cause: Throwable? = null) : StatusCodeException.UnAuthorized(message, cause)
